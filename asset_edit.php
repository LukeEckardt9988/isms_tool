...
<style>
    /* Ihre bestehenden .edit-form, .form-group, etc. Styles */
    .edit-form fieldset {
    ...
    /* Gilt für alle input, textarea, select innerhalb .form-group für Konsistenz */
    ...
    .checkbox-list-container {
        /* Container für die Checkbox-Gruppen */
        max-height: 300px;
        /* Maximale Höhe, bevor Scrollen beginnt */
        overflow-y: auto;
    ...
    .checkbox-list-container .control-category {
        ...
        margin-bottom: 10px;
        /* padding: 5px; */
        /* Weniger Padding für kompaktere Ansicht */
        /* border: 1px solid #e0e0e0; */
        /* Rand um Kategorie optional */
        /* border-radius: 4px; */
    }
    ...
    .checkbox-list-container .checkbox-item {
        /* Gilt für Risiko- und Control-Checkboxes */
        display: block;
        margin-bottom: 3px;
        font-weight: normal;
        font-size: 0.9em;
    ...
    /* Styles für Flash Messages (success, error) sollten global sein */
    .success {
        /* ... */
    }
